    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <DashboardCard 
            ...
            description="Choose a subject and test your knowledge with a new quiz."
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 md:col-span-2 lg:col-span-3">
             ...
             <div className="flex flex-wrap gap-3">
                {user.subjects && user.subjects.length > 0 ? (
                    ...
                    <p className="text-slate-500">You haven't selected any subjects yet. Go to your profile to add some!</p>
                )}
             </div>
        </div>
      </div>
